      ...
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="right">Mã khóa học</TableCell>
            <TableCell align="right">Bí danh</TableCell>
            ...
            <TableCell align="center">Danh mục khóa học</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>{}</TableBody>
      </Table>
